    ...
    <div className="matchDetail">
      ...
      <section>
        ...
        <div className="container">
          <div className="chip">{match.gender}매치</div>
          <div className="chip">
            최대 {match.memberCount}명 ({match.teamCount}파전)
          </div>
          <div className="chip">{match.level}레벨</div>
        </div>
        <div className="container">
          <div className="chip">{match.gameType}</div>
          <div className="chip">
            풋살화 대여 {match.canRentShoes ? "가능" : "불가능"}
          </div>
          <div className="chip">주차 {match.canPark ? "가능" : "불가능"}</div>
        </div>
        <p className="details">
